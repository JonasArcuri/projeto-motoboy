...
public class AuthResponse {
    ...
    private String tipo;
    private String token; // mensagem
    private Long estabelecimentoId; // 🔹 novo campo

    // Construtor completo
    public AuthResponse(Long id, String name, String email, String tipo, String message, Long estabelecimentoId) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.tipo = tipo;
    ...
    // Construtor sem estabelecimentoId (para motoboys, etc.)
    public AuthResponse(Long id, String name, String email, String tipo, String message) {
        this(id, name, email, tipo, message, null);
    }
